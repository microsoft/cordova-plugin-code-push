...
*NOTE: For Cordova 4, 5 there is a possibility to specify WebView engine on the plugin build phase. By default UIWebView engine is used. You can force plugin to use WKWebView by installing [cordova-plugin-wkwebview-engine](https://www.npmjs.com/package/cordova-plugin-wkwebview-engine) and adding this iOS specific preference:*
```xml
